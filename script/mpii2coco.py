...
annot_file = loadmat('../data/dataset/mpii/annotations/annotations.mat')['RELEASE']
save_path = '../data/dataset/mpii/annotations/' + db_type + '.json'
...
for img_id in range(img_num):
    ...
    if ((db_type == 'train' and annot_file['img_train'][0][0][0][img_id] == 1) or (
        ...
        img = Image.open(osp.join('../data/dataset/mpii/images', filename))
        w, h = img.size
        img_dict = {
            'id': img_id,
            'file_name': filename,
        ...
        person_num = len(annot_file['annolist'][0][0]
                         [0][img_id]['annorect'][0])  # person_num
